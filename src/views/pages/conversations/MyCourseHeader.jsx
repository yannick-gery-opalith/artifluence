    ...
    <Card className='relative flex justify-center'>
      ...
      <div className='flex flex-col items-center gap-4 max-md:pli-5 plb-12 md:is-1/2'>
        <Typography variant='h4' className='text-center md:is-3/4'>
          Conversations, meetings, intelligence. <span className='text-primary'>All in one place.</span>
        </Typography>
        <Typography className='text-center'>
          Never miss highlights thanks to voice intelligence transforming unstructured conversations into reliable and
          structured insights.
        </Typography>
