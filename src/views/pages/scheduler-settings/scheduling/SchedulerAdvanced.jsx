...
import { Avatar, CardHeader, InputAdornment, IconButton, Switch, FormControlLabel, Divider } from '@mui/material'
          ...
          <Grid container spacing={6}>
            <Grid size={{ xs: 12 }} className='flex gap-4 flex-wrap'>
              <div className='flex justify-between items-center w-full'>
                ...
                <Switch checked={isActive} onChange={isActiveChange} color='success' />
              </div>
            ...
            <Grid size={{ xs: 12 }} className='flex gap-4 flex-wrap'>
              <div className='flex justify-between items-center w-full'>
                ...
                <Switch checked={autoTranslate} onChange={autoTranslateChange} color='success' />
              </div>
              <Divider className='flex  w-full' />
            </Grid>
          </Grid>
